...
java -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5005 -server -Dfile.encoding=UTF-8 -Xmx2G -XX:+UseTLAB -verbose:gc -XX:+PrintGCDetails -Xloggc:./gc.log -cp config;./../libs/* l2f.gameserver.GameServer
